...
namespace velodyne_pointcloud 
{
  ...
  public:
    ...
    virtual void addPoint(const float& x, const float& y, const float& z, const uint16_t& ring, const uint16_t& azimuth, const float& distance, const float& intensity, const uint32_t& time);
  };
}
